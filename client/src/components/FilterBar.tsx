        ...
        <div className="flex flex-col gap-4">
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-12 glassmorphic border-white/10 h-10 w-full"
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:flex gap-2 flex-1">
              ...
              <Select value={selectedLanguage} onValueChange={onLanguageChange}>
                <SelectTrigger className="glassmorphic border-white/10 h-10 w-full lg:min-w-[130px]" data-testid="select-language">
              ...
              <Select value={selectedLocation} onValueChange={onLocationChange}>
                <SelectTrigger className="glassmorphic border-white/10 h-10 w-full lg:min-w-[120px]" data-testid="select-location">
              ...
              <Select value={selectedEventType} onValueChange={onEventTypeChange}>
                <SelectTrigger className="glassmorphic border-white/10 h-10 w-full lg:min-w-[130px]" data-testid="select-event-type">
            ...
            {hasActiveFilters && (
              <Button
                ...
                className="glassmorphic border-white/10 h-10 w-full md:w-auto"
